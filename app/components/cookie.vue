		...
		<div class="cookie" v-if="isActive">
			<div class="cookie__content">
				...
				<p class="text-16">
					...
					They are widely used to enhance user experience by remembering your preferences,
					enabling functionalities, and providing insights into website performance.
				</p>
			</div>
			<div class="cookie__buttons">
				<button
					class="cookie__button cookie__button--reject"
					@click="acceptCookie('reject')">
					Reject
				</button>
				<button
					class="cookie__button cookie__button--accept"
					@click="acceptCookie('accept')">
					Accept
				</button>
			</div>
		</div>
...
onMounted(() => {
	...
	cookie ? (isActive.value = false) : (isActive.value = true);
});
</script>
