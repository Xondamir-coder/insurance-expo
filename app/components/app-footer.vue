<template>
  <footer v-if="!$route.name.includes('index')" id="footer" class="footer">
      ...
      <div class="footer__cols">
        ...
        <div class="footer__col">
          ...
          <div class="footer__social">
            <a class="footer__social-item" href="#" target="_blank" rel="noopener noreferrer">
